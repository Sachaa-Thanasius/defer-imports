...
class DeferredInteractiveConsole(InteractiveConsole):
    """An emulator of the interactive Python interpreter, but with deferred's compile-time hook installed beforehand to
    ensure that defer_imports_until_use works as intended directly in the console.
    """
